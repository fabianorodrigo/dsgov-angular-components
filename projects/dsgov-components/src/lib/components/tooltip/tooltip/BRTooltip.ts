/**
 * Código copiado de: https://dsgov.estaleiro.serpro.gov.br/components/tooltip?tab=desenvolvedor
 * na versão 2.1.0-BETA e convertido para Typescript
 *
 * Houve um pequeno ajuste no construtor para o código funcionar: o parâmetro 'component' está recebendo
 * o componente Angular (<br-tooltip></br-tooltip>), para o Javascript do DSGov funcionar, a referência
 * deve apontar para o seu primeiro DIV (firstChild)
 */
...
export class BRTooltip {
  ...
  constructor(name, componentAngular) {
    //o nó recebido pelo construtor é o nó do component Angular (br-tooltip)
    //o código Javascript do DSGov atua sobre a DIV com o class 'br-tooltip'
    const component = componentAngular.firstChild;
    this.name = name;
    this.component = component;
    //Outra alteração necessária ao funcionamento: this.activator foi a referência
    //para o activator
    this.activator = componentAngular.previousSibling;
